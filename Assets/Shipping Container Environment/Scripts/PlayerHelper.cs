    ...
    */
    ...
    void Update () {
        ...
        */
        ...
        if (!isDead)
		{
            ...
            if (Input.GetButtonUp("EquipWeapon") && Aiming == false && charController.Sprinting == false && charController.Rolling == false) //mar 28 && isThrowing == false)
            {
            ...
            */
            ...
            {
                if (charController.Rolling == false) // mar 28 && isThrowing == false)
                {
			...
			{
                if (charController.Rolling == false && charController.Sprinting == false) // mar 28 && isThrowing == false)
                {
                   WeaponReload();
                }
			}
			...
			{
                if (charController.Rolling == false && charController.Sprinting == false && !UsingObject && Armed == false)//mar 28 && isThrowing == false)
                {
                    if (Weapon[ActiveWeapon].GetComponent<PrWeapon>().Type != global::PrWeapon.WT.Melee)
                    {
                        if (!alwaysAim)
                        {
                            Aiming = true;
                            if (Weapon[ActiveWeapon].GetComponent<PrWeapon>().Reloading == true)// mar 28 || isThrowing == true)
                                Weapon[ActiveWeapon].GetComponent<PrWeapon>().LaserSight.enabled = false;
                            else
    ...
    void LateUpdate()
    {
        ...
        */
        ...
        if (aimingIK)
        {
            if (Aiming && !Weapon[ActiveWeapon].GetComponent<PrWeapon>().Reloading && !charController.Rolling && !charController.Jumping && !charController.Sprinting) //mar 28 && !isThrowing)
            {
