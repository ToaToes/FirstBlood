...
public class PlayerController : MonoBehaviour {
    ...
    private PlayerHelper Inventory;

    void Start()
	{
        Inventory = GetComponent<PlayerHelper>();
    ...
    */
    ...
    void FixedUpdate(){
    	...
    	m_Rigidbody.AddForce(movement * PlayerRunSpeed);
    }
    ...
    void Update () {
        ...
        if (!m_isDead && m_CanMove)
		{
            ...
            /*
            mar 28
            if (Input.GetButton("Roll") && !Rolling && !Inventory.UsingObject && Inventory.ActualStamina > RollStaminaUse)
            {
            ...
            */
            ...
            /*
            mar 28
            if (Input.GetButton("Roll") &&!Rolling && !m_Jump && !Inventory.UsingObject && !crouch && Time.time >= lastJump + 0.2f && m_IsGrounded && b_canJump)
            {
    ...
    */
	...
	public void Move(Vector3 move, bool jump)
	{
        if (!Inventory.UsingObject)
        {
            ...
            //if (m_IsGrounded){HandleGroundedMovement(crouch, jump);}//mar 28
            //else{HandleAirborneMovement();}//mar 28

            //ScaleCapsuleForCrouching(crouch);//mar 28
            //PreventStandingInLowHeadroom();//mar 28
